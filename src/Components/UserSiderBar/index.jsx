      ...
      <Box className="userSideBar">
        <Box className="userSideBar__left">
          ...
          <Box className="userSideBar__navigator">
            <Box className="userSideBar__navigator__body">
              ...
              >
                <Nav.Item>
                  <Nav.Link className="userSideBar__navigator__link" active eventKey="first">
                    <DynamicFeedIcon />
                    <h5>Feed</h5>
                  </Nav.Link>
                </Nav.Item>
                ...
                <Nav.Item>
                  <Nav.Link className="userSideBar__navigator__link" eventKey="second">
                    <CommentIcon />
                    <h5>Messenger</h5>
                  </Nav.Link>
                </Nav.Item>
                ...
                <Nav.Item>
                  <Nav.Link className="userSideBar__navigator__link" eventKey="third">
                    <ContactsIcon />
                    <h5>Information</h5>
                  </Nav.Link>
                </Nav.Item>
                ...
                <Nav.Item>
                  <Nav.Link className="userSideBar__navigator__link" eventKey="fourth">
                    <SettingsIcon />
                    <h5>Settings</h5>
                  </Nav.Link>
                </Nav.Item>
        ...
        <Box className="userSideBar__right">
          <Tab.Content>
            ...
            <Tab.Pane eventKey="second"><UserMessage /></Tab.Pane>

            <Tab.Pane eventKey="third"><UserBio /></Tab.Pane>

            <Tab.Pane eventKey="fourth"><UserSetting /></Tab.Pane>
          </Tab.Content>
        </Box>
      </Box>
    </>
